 ...
 * Payments Model
 *
 * @property \App\Model\Table\EstablishmentAccountsTable|\Cake\ORM\Association\BelongsTo $EstablishmentAccounts
...
class PaymentsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('EstablishmentAccounts', [
            'foreignKey' => 'establishment_account_id'
        ]);
    ...
    {
        $rules->add($rules->existsIn(['establishment_account_id'], 'EstablishmentAccounts'));
