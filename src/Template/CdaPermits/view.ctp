...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Cda Permit'), ['action' => 'edit', $cdaPermit->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Cda Permit'), ['action' => 'delete', $cdaPermit->id], ['confirm' => __('Are you sure you want to delete # {0}?', $cdaPermit->id)]) ?> </li>
...
<div class="cdaPermits view large-9 medium-8 columns content">
    <h3><?= h($cdaPermit->id) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($cdaPermit->establishment_accounts)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($cdaPermit->establishment_accounts as $establishmentAccounts): ?>
            <tr>
