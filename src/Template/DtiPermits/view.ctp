...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Dti Permit'), ['action' => 'edit', $dtiPermit->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Dti Permit'), ['action' => 'delete', $dtiPermit->id], ['confirm' => __('Are you sure you want to delete # {0}?', $dtiPermit->id)]) ?> </li>
...
<div class="dtiPermits view large-9 medium-8 columns content">
    <h3><?= h($dtiPermit->id) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($dtiPermit->establishment_accounts)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($dtiPermit->establishment_accounts as $establishmentAccounts): ?>
            <tr>
