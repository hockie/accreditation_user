 ...
 * @var \App\Model\Entity\AuthorizedRepresentative $authorizedRepresentative
 */
?>
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        <li class="heading"><?= __('Actions') ?></li>
        <li><?= $this->Html->link(__('Edit Authorized Representative'), ['action' => 'edit', $authorizedRepresentative->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Authorized Representative'), ['action' => 'delete', $authorizedRepresentative->id], ['confirm' => __('Are you sure you want to delete # {0}?', $authorizedRepresentative->id)]) ?> </li>
        <li><?= $this->Html->link(__('List Authorized Representatives'), ['action' => 'index']) ?> </li>
...
<div class="authorizedRepresentatives view large-9 medium-8 columns content">
    <h3><?= h($authorizedRepresentative->id) ?></h3>
    ...
    <div class="row">
        <h4><?= __('Remarks') ?></h4>
        <?= $this->Text->autoParagraph(h($authorizedRepresentative->remarks)); ?>
    </div>
    <div class="related">
        <h4><?= __('Related Establishment Accounts') ?></h4>
        <?php if (!empty($authorizedRepresentative->establishment_accounts)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($authorizedRepresentative->establishment_accounts as $establishmentAccounts): ?>
            <tr>
